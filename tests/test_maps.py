...
if __name__ == "__main__":
    ...
    game.set_doom_scenario_path(os.path.join('wads', 'curiosity_training.wad'))
    ...
    available_actions = [vzd.Button.MOVE_LEFT, vzd.Button.MOVE_RIGHT, 
                        vzd.Button.MOVE_FORWARD, vzd.Button.MOVE_BACKWARD,
                        vzd.Button.TURN_RIGHT, vzd.Button.TURN_LEFT]
    game.set_available_buttons(available_actions)
    ...
    def make_actions(available_actions):
        actions = []
        l = len(available_actions)
        for i in range(l):
            ll = [False]*l
            ll[i] = True
            actions.append(ll)
    ...
    actions = make_actions(available_actions)
